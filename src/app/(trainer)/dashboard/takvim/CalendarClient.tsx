...
export default function CalendarClient({ clients, trainerId }: { clients: Client[]; trainerId: string }) {
  ...
  const fetchLessons = useCallback(async () => {
    ...
    const mapped: CalendarEvent[] = (lessons || []).map((l) => {
      const clientName = (l.clients as unknown as { full_name: string })?.full_name || 'Bilinmeyen'
  ...
  function handleModalSave(_change: LessonChange) {
    setModalOpen(false)
    setSelectedEvent(null)
    fetchLessons()
  }
