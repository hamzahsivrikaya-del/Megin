...
export default function MemberProfilePage() {
  ...
  useEffect(() => {
    async function loadProfile() {
      ...
      const [{ data: profile }, { data: firstLesson }] = await Promise.all([
        supabase
          .from('users')
      ...
      if (profile) {
        ...
        setStartDate(firstLesson?.date || profile.start_date || null)
      }
              ...
              {badges.map((badge) => {
                ...
                return (
                  <button
                    ...
                    className={`badge flex flex-col items-center gap-1.5 p-3 rounded-xl transition-all${
                      earned
