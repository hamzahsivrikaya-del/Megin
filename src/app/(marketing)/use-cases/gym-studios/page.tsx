...
import { Building2, ArrowRight, Check, LayoutDashboard, ArrowLeftRight, TrendingUp, Database, BellRing, UserPlus, Star } from 'lucide-react'
...
const segment = en.useCases.segments[1]
const t: MarketingTranslations = en

const FEATURE_ICONS = [LayoutDashboard, ArrowLeftRight, TrendingUp, Database, BellRing, UserPlus]
...
export const metadata: Metadata = {
  ...
  alternates: {
    languages: {
      en: '/use-cases/gym-studios',
      tr: '/tr/use-cases/gym-studios',
    },
  },
}

export default function GymStudiosPage() {
  return (
    <>
      {/* 1. Hero */}
            ...
            <div>
              ...
              <div className="space-y-3">
                {segment.comparisonBefore.map((item: string) => (
                  <div key={item} className="flex items-start gap-3 bg-white rounded-lg border border-[#E5E7EB] p-3 sm:p-4 transition-all duration-300 hover:shadow-md">
