            ...
            <table className="w-full border-collapse min-w-[500px]">
              <thead>
                <tr className="bg-[#0A0A0A]">
                  <th className="text-left text-xs font-semibold text-white/40 uppercase tracking-wider py-5 px-5 sm:px-6 w-[30%]">
                    Feature
                  </th>
                  ...
                  <th className="text-center text-xs font-semibold text-white/30 uppercase tracking-wider py-5 px-3 w-[21%]">
                    {t.comparison.excel}
                  </th>
                  <th className="text-center text-xs font-semibold text-white/30 uppercase tracking-wider py-5 px-3 w-[21%]">
              ...
              <tbody>
                {t.comparison.rows.map((row, i) => (
                  <tr
                    key={row.feature}
                    className={`mkt-reveal border-t border-[#F3F4F6] transition-colors hover:bg-green-50/30 ${i % 2 === 0 ? 'bg-white' : 'bg-[#FAFAFA]/50'}`}
                  >
